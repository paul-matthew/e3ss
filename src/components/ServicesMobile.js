...
function Services() {
  ...
  return (
    ...
    <div className="Services-mobile" style={{width: '100vw', height: 'auto', right:'0', position: 'relative', background: 'white', display: "none"}}>
        {desktopState === 'Services1' && (
        <div>
            <div className="Servicesx" style={{width: '100vw', position: 'relative', background: 'white',top: '10vh'}}>
                <div className="Servicesdesktop" style={{width: '100vw',  left: 0, top: 0, position: 'relative', background: 'white', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'flex-start', gap: 1, display: 'inline-flex'}}>
                    <div className="Home" style={{height: 'auto', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 124, display: 'inline-flex', marginBottom: "2rem"}}>
                        <div className="IntroSection" style={{alignSelf: 'stretch', height: "auto", justifyContent: 'flex-start', alignItems: 'center', display: 'inline-flex'}}>
                            <div className="Frame1" style={{flex: '1 1 0', alignSelf: 'stretch', top: "20px", paddingLeft: "5vw", paddingRight: "5vw", flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 20, display: 'inline-flex'}}>
                    ...
                    <div className="BodyX" style={{maxWidth:'100vw',flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 48, display: 'inline-flex'}}> 
                        ...
                        <div className="IntroSection" style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'center', display: 'inline-flex'}}>
                            <div className="Frame1" style={{flex: '1 1 0', height: "auto", paddingLeft: "5vw", paddingRight: "5vw", flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center', gap: 45, display: 'inline-flex', marginBottom: "3rem"}}>
