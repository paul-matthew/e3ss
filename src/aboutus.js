...
function About() {
  ...
  return (
    ...
    <div className="AboutUs" style={{width: '100vw', height: '100vh', right:'0', position: 'relative', background: 'white'}}>
        {desktopState === 'About1' && (
        <div>
            ...
            <div className="Aboutus" style={{width: '100vw', height: '100vh', left: 0, top: '10vh', position: 'absolute', background: 'white'}}>
                    ...
                    <div className="Footerprivacy" style={{width: 356, height: 43, left: 672, top: 0, position: 'absolute', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                        <div className="HeadingName" style={{paddingTop: 9, paddingBottom: 9, justifyContent: 'center', alignItems: 'flex-start', gap: 50, display: 'flex'}}>
                            <div className="HeaderMenuDefault" style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                                <div className="Label" style={{color: 'white', fontSize: 'clamp(10px, 1vw, 10px)', fontFamily: 'Roboto', fontWeight: '500', lineHeight: 24, wordWrap: 'break-word'}}>Terms of Use</div>
                            </div>
                            <div className="MenuItemDefault" style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                                <div className="Label" style={{color: 'white', fontSize: 'clamp(10px, 1vw, 10px)', fontFamily: 'Roboto', fontWeight: '500', lineHeight: 24, wordWrap: 'break-word'}}>Privacy</div>
                            </div>
                            <div className="MenuItemDefault" style={{alignSelf: 'stretch', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                                <div className="Label" style={{color: 'white', fontSize: 'clamp(10px, 1vw, 10px)', fontFamily: 'Roboto', fontWeight: '500', lineHeight: 24, wordWrap: 'break-word'}}>Contact</div>
                            </div>
                        </div>
                    </div>
        ...
        <div className="Navmenudesktop" style={{zIndex:2, width: '80vw', height: '10vh', right: '0vw', position: 'absolute', justifyContent: 'flex-end', alignItems: 'flex-end', display: 'inline-flex'}}>
            <div className="ListitemDesktopNaActive" style={{width: 'clamp(83px, 3vw, 16px)', height: '100%', paddingLeft: 18, paddingRight: 18, paddingTop: 0, paddingBottom: 0, background: '#FFD700', justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                <div className="Label" style={{width: 100, textAlign: 'center', color: 'black', fontSize: 'clamp(13px, 2vw, 16px)', fontFamily: 'Roboto', fontWeight: '500', letterSpacing: 2, wordWrap: 'break-word'}}>About Us</div>
            </div>
        ...
        {/* <div className="Navdesktop" style={{zIndex:0, position: 'absolute'}}>
            ...
            <div className="Navlogo" style={{width: 99, height:'10vh', left: 39, top: 0, position: 'absolute', justifyContent: 'flex-start', alignItems: 'center', display: 'inline-flex'}}>
                <div className="Logos" style={{justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
